...
public interface DeliverDao
    ...
    @Query(value = "SELECT * FROM shop_deliver WHERE deliverno=:deliverno", nativeQuery = true)
    DeliverModel getDeliverByDeliverNo(@Param(value = "deliverno") String deliverno);
